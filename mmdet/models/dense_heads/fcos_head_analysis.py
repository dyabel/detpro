...
class FCOSHeadAnalysis(AnchorFreeHeadAnalysis):
    ...
    def loss(self,
        ...
        for i, featmap_size in enumerate(featmap_sizes):
            ...
            cur_pos_anchor_flags = pos_anchor_flags[pre_idx:pre_idx+cur_featmap_size]
            cur_pos_anchor_flags = cur_pos_anchor_flags.view(1, 1, featmap_size[0], featmap_size[1])
            save_image(cur_pos_anchor_flags, f"analysis_results_fcos/image_{batch_idx}_feature_{i}_flatten_anchor_flags_scale_{analysis_scale}.png")
