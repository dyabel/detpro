...
class StandardRoIHeadTEXTPrompt(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(StandardRoIHeadTEXTPrompt, self).__init__(bbox_roi_extractor=bbox_roi_extractor,
                                              bbox_head=bbox_head,
        ...
        save_path = 'neg0104_halfbg_ens.pth'
